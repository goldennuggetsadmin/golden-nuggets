"""Sermon Service — Shared domain logic for sermon management, filtering, and category matching.
Provides a single source of truth for series and category query filters across admin, mobile, and search endpoints.
"""
