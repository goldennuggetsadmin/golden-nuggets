...
export default function SermonsList() {
  ...
  const delMut = useMutation({
    ...
    onError: (e) => toast.error(formatApiErrorDetail(e) || "Failed to delete sermon"),
  });
  ...
  const featureMut = useMutation({
    ...
    onError: (e) => toast.error(formatApiErrorDetail(e) || "Failed to update featured state"),
  });
  ...
  const publishMut = useMutation({
    ...
    onError: (e) => toast.error(formatApiErrorDetail(e) || "Failed to update sermon status"),
  });
  ...
  const bulkMut = useMutation({
    ...
    onError: (e) => toast.error(formatApiErrorDetail(e) || "Failed to complete bulk action"),
  });
